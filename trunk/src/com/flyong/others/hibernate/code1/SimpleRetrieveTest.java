package com.flyong.others.hibernate.code1;
...
public class SimpleRetrieveTest {
  ...
  public static void main(String[] args) {
    HibernateUtil
        .setup("create table EVENTS ( uid int, name VARCHAR, start_Date date, duration int, location_id int);");
    HibernateUtil
        .setup("create table locations ( uid int, name VARCHAR, street_address VARCHAR, city VARCHAR, state VARCHAR, zip_Code VARCHAR);");
